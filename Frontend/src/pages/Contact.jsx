...
export const Contact = () => {
  return (
    <section className="bg-white dark:bg-slate-100-400 ">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md ">
        ...
        <form action="#" className="space-y-8">
          <div>
            ...
            <input type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-200 dark:border-gray-400 dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="name@gmail.com" required />
          </div>
          <div>
          ...
          <button type="submit" className="py-3 px-5 text-sm font-medium text-center rounded-lg bg-blue-400 hover:text-white sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none   ">Send message</button>
        </form>
      </div>
    </section>
  );
